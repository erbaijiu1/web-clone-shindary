...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const categoryContent = computed(() => {
      ...
      return {
        seoTitle: ((_a = activeCategory.value) == null ? void 0 : _a.name) || "Products",
        displayTitle: ((_b = activeCategory.value) == null ? void 0 : _b.name) || "Products",
        keywords: ((_c = activeCategory.value) == null ? void 0 : _c.name) || "Auto Spare Parts",
        description: `${((_d = activeCategory.value) == null ? void 0 : _d.name) || "This collection"} at Shindary Automotive Parts.`,
...
//# sourceMappingURL=_categorySlug_-adSQl_Zs.mjs.map
