...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const hotProducts = computed(() => {
      var _a, _b, _c, _d;
      return ((_d = (_c = (_b = (_a = shell.value) == null ? void 0 : _a.product_tabs) == null ? void 0 : _b[3]) == null ? void 0 : _c.items) == null ? void 0 : _d.slice(0, 4)) || [];
    });
    useHead(() => {
      var _a;
      const seo = (_a = customerPage.value) == null ? void 0 : _a.seo;
      if (!seo) {
...
//# sourceMappingURL=index-CnXG_ISI.mjs.map
