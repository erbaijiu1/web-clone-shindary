...
import { computed, toValue, reactive, watch, ref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createTextVNode, getCurrentInstance, onServerPrefetch, shallowRef, nextTick, unref, toRef, useSSRContext, defineComponent, createElementBlock, provide, cloneVNode, h } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><p class="text-sm text-slate-400">Copyright \xA9 Shindary Automotive Parts Co., Ltd. All Rights Reserved</p></div></div></footer>`);
    };
  }
};
...
//# sourceMappingURL=fetch-DLe7Ubau.mjs.map
