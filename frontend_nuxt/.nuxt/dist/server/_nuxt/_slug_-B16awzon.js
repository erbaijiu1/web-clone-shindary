  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pendingShell) || unref(pendingArticle)) {
        ...
        _push(`<div class="prose prose-slate max-w-none prose-img:rounded-sm prose-img:border prose-img:border-slate-200 prose-img:shadow-none">${unref(article).content ?? ""}</div><div class="mt-10 space-y-3 border-t border-slate-200 pt-6 text-sm text-slate-600"><p> Previous: `);
...
//# sourceMappingURL=_slug_-B16awzon.js.map
